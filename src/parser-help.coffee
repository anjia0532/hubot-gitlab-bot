...
HELP = [HELP_BRANCH, HELP_PROJECT, HELP_MERGE_REQUEST, HELP_MERGE_REQUEST_ACCEPT, HELP_MERGE_REQUEST_ACCEPT_BRANCH,
  HELP_PIPELINE, HELP_VERSION, HELP_DEFAULT].join('  \n  ')
